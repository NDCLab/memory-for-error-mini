...
for subject=1:length(datafile_names)
    ...
    resp_incon_error = length(find( strcmp({EEG.event.eventType}, 'resp') & strcmp({EEG.event.congruency}, 'i') & ([EEG.event.accuracy] == 0) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));     
    resp_incon_correct = length(find( strcmp({EEG.event.eventType}, 'resp') & strcmp({EEG.event.congruency}, 'i') & ([EEG.event.accuracy] == 1) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));                         
    resp_con_correct = length(find( strcmp({EEG.event.eventType}, 'resp') & strcmp({EEG.event.congruency}, 'c') & ([EEG.event.accuracy] == 1) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));             
    
    stim_incon_error = length(find( strcmp({EEG.event.eventType}, 'stim') & strcmp({EEG.event.congruency}, 'i') & ([EEG.event.accuracy] == 0) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));             
    stim_incon_correct = length(find( strcmp({EEG.event.eventType}, 'stim') & strcmp({EEG.event.congruency}, 'i') & ([EEG.event.accuracy] == 1) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));             
    stim_con_error = length(find( strcmp({EEG.event.eventType}, 'stim') & strcmp({EEG.event.congruency}, 'c') & ([EEG.event.accuracy] == 0) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));             
    stim_con_correct = length(find( strcmp({EEG.event.eventType}, 'stim') & strcmp({EEG.event.congruency}, 'c') & ([EEG.event.accuracy] == 1) & ([EEG.event.responded] == 1) & ([EEG.event.validRt] == 1)  ));             
