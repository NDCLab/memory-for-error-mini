...
threshold_num <- 14 # threshold for the minimum number of incong errors
...
write.csv(split_scores, paste(output_path, "split_scores_hitRate_14_1000rep.csv", sep = "/", collapse = NULL), row.names=FALSE)

coefs_per_round <- split_coefs(split_scores, spearman_brown)
write.csv(coefs_per_round, paste(output_path, "coefs_per_round_hitRate_14_1000rep.csv", sep = "/", collapse = NULL), row.names=FALSE)

# Mean of coefficients
avg_coefs_per_round <- mean(coefs_per_round)
write.csv(avg_coefs_per_round, paste(output_path, "avg_coefs_per_round_hitRate_14_1000rep.csv", sep = "/", collapse = NULL), row.names=FALSE)
