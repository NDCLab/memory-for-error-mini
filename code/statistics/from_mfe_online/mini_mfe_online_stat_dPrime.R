...
percent_mainDat <- setNames(data.frame(matrix(ncol = 57, nrow = 0)), c("id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
                                                                       "flankEff_meanACC", "flankEff_meanRT", "flankEff_logMeanRT",
                                                                       "reported_errors", "committed_errors", "memoryBias_score",
  ...
  if (nrow(incong_errorDat) >= outlier_num){ #for when the participant has outlier_num or more than outlier_num incongruent errors
    ...
    for (donya in 1:nrow(surpDat)){
      ...
      if (nrow(temp_cut_from_flanker) == 1){ # The face is old
        if (surpDat$newKey[donya] == surpDat$surprise_key_resp.keys[donya]){
          miss_num <- miss_num + 1
        } else if (surpDat$newKey[donya] != surpDat$surprise_key_resp.keys[donya]){
          hit_num <- hit_num + 1
        }
...
for (farideh in 1:nrow(percent_mainDat)){
  ...
  percent_mainDat$d_prime_error_minus_pre_error[farideh] <- percent_mainDat$d_prime_error[farideh] - percent_mainDat$pre_d_prime_error[farideh]
  percent_mainDat$d_prime_post_error_minus_pre_error[farideh] <- percent_mainDat$post_d_prime_error[farideh] - percent_mainDat$pre_d_prime_error[farideh]
}
...
t.test((as.numeric(percent_mainDat$d_prime_error)), (as.numeric(percent_mainDat$d_prime_correct)), paired = TRUE)
t.test((as.numeric(percent_mainDat$pre_d_prime_error)), (as.numeric(percent_mainDat$pre_d_prime_correct)), paired = TRUE)
...
for (zesht4 in 1:nrow(percent_mainDat)){
  if (!is.na(as.numeric(percent_mainDat$memoryBias_score[zesht4])) && !is.na(as.numeric(percent_mainDat$d_prime_error[zesht4])) && !is.na(as.numeric(percent_mainDat$d_prime_error_minus_pre_error[zesht4])) && !is.na(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error[zesht4])) && !is.na(as.numeric(percent_mainDat$d_prime_correct[zesht4])) && !is.na(as.numeric(percent_mainDat$post_d_prime_error[zesht4])) && !is.na(as.numeric(percent_mainDat$post_d_prime_correct[zesht4])) && !is.na(as.numeric(percent_mainDat$scaared_b_scrdSoc_s1_r1_e1[zesht4])) && !is.na(as.numeric(percent_mainDat$scaared_b_scrdTotal_s1_r1_e1[zesht4])) && !is.na(as.numeric(percent_mainDat$scaared_b_scrdGA_s1_r1_e1[zesht4])) && !is.na(as.numeric(percent_mainDat$d_prime_error_minus_correct[zesht4])) && !is.na(as.numeric(percent_mainDat$post_d_prime_error_minus_correct[zesht4])) && !is.na(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1[zesht4]))){
    ...
    if (as.numeric(percent_mainDat$d_prime_error_minus_pre_error[zesht4]) >= (mean(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), na.rm = TRUE) - (3*sd(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), na.rm = TRUE))) && as.numeric(percent_mainDat$d_prime_error_minus_pre_error[zesht4]) <= (mean(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), na.rm = TRUE) + (3*sd(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), na.rm = TRUE)))){
      percent_mainDat$d_prime_error_minus_pre_error[zesht4] <- as.numeric(percent_mainDat$d_prime_error_minus_pre_error[zesht4])
    } else {
      percent_mainDat$d_prime_error_minus_pre_error[zesht4] <- NA
    }

    if (as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error[zesht4]) >= (mean(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), na.rm = TRUE) - (3*sd(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), na.rm = TRUE))) && as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error[zesht4]) <= (mean(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), na.rm = TRUE) + (3*sd(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), na.rm = TRUE)))){
      percent_mainDat$d_prime_post_error_minus_pre_error[zesht4] <- as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error[zesht4])
    } else {
      percent_mainDat$d_prime_post_error_minus_pre_error[zesht4] <- NA
    }
...
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$post_d_prime_error_minus_correct), method = 'pearson')
...
ggplot(percent_mainDat, aes(x=post_d_prime_error_minus_correct, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot

cor.test(as.numeric(percent_mainDat$scaared_b_scrdSoc_s1_r1_e1), as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), method = 'pearson')
cor.test(as.numeric(percent_mainDat$scaared_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), method = 'pearson')
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), method = 'pearson')
ggplot(percent_mainDat, aes(x=d_prime_post_error_minus_pre_error, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=d_prime_post_error_minus_pre_error, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=d_prime_post_error_minus_pre_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot

cor.test(as.numeric(percent_mainDat$scaared_b_scrdSoc_s1_r1_e1), as.numeric(percent_mainDat$d_prime_error_minus_pre_error), method = 'pearson')
cor.test(as.numeric(percent_mainDat$scaared_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_error_minus_pre_error), method = 'pearson')
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_error_minus_pre_error), method = 'pearson')
ggplot(percent_mainDat, aes(x=d_prime_error_minus_pre_error, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=d_prime_error_minus_pre_error, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=d_prime_error_minus_pre_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot


lm_for_cor_fit_line <- lm(scaared_b_scrdSoc_s1_r1_e1 ~ d_prime_error_minus_correct, percent_mainDat)
...
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_error_minus_correct), method = 'pearson')
ggplot(percent_mainDat, aes(x=d_prime_error_minus_correct, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point()
ggplot(percent_mainDat, aes(x=d_prime_error_minus_correct, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=d_prime_error_minus_correct, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
...
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$post_d_prime_error), method = 'pearson')
...
ggplot(percent_mainDat, aes(x=post_d_prime_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
...
cor.test(as.numeric(percent_mainDat$bfne_b_scrdTotal_s1_r1_e1), as.numeric(percent_mainDat$d_prime_error), method = 'pearson')
...
ggplot(percent_mainDat, aes(x=d_prime_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
...
cor.test(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), as.numeric(percent_mainDat$post_error_slowing_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), as.numeric(percent_mainDat$post_error_slowing_score), method = 'pearson')
...
ggplot(percent_mainDat, aes(x=post_error_slowing_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(percent_mainDat, aes(x=post_error_slowing_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
...
cor.test(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), as.numeric(percent_mainDat$post_error_accuracy_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), as.numeric(percent_mainDat$post_error_accuracy_score), method = 'pearson')
...
ggplot(percent_mainDat, aes(x=post_error_accuracy_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(percent_mainDat, aes(x=post_error_accuracy_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot

lm_for_cor_fit_line <- lm(d_prime_error_minus_correct ~ memoryBias_score, percent_mainDat)
cor.test(as.numeric(percent_mainDat$d_prime_error), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$post_d_prime_error), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$d_prime_error_minus_correct), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$post_d_prime_error_minus_correct), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$d_prime_error_minus_pre_error), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
cor.test(as.numeric(percent_mainDat$d_prime_post_error_minus_pre_error), as.numeric(percent_mainDat$memoryBias_score), method = 'pearson')
ggplot(percent_mainDat, aes(x=memoryBias_score, y=d_prime_error)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=memoryBias_score, y=post_d_prime_error)) + geom_point() #scatterplot
ggplot(percent_mainDat, aes(x=memoryBias_score, y=d_prime_error_minus_correct)) + geom_point()
ggplot(percent_mainDat, aes(x=memoryBias_score, y=post_d_prime_error_minus_correct)) + geom_point(size = 4) #scatterplot
ggplot(percent_mainDat, aes(x=memoryBias_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(percent_mainDat, aes(x=memoryBias_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot