...
main_df <- setNames(data.frame(matrix(ncol = 76, nrow = 0)), c("participant_id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
...
long_df <- setNames(data.frame(matrix(ncol = 6, nrow = 0)), c("id", "accuracy", "position", "hitRate", "dPrime", "condition_trial_num")) # will store data of all participants
participant_long_df <- setNames(data.frame(matrix(ncol = 6, nrow = 6)), c("id", "accuracy", "position", "hitRate", "dPrime", "condition_trial_num"))
