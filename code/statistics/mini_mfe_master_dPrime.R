...
rt_df <- setNames(data.frame(matrix(ncol = 3, nrow = 0)), c("id", "shortest_allowed_rt", "number_of_removed_trials_in_the_surp")) # this dataframe will store the number of removed trials in the surp!
...
for(i in 1:length(datafiles_list)){
  ...
  if (accuracy >= 0.6){ # checks if they have falnker accuracy above 60%!
    ...
    rt_df[nrow(rt_df) + 1,] <-c(id, shortest_allowed_rt, number_of_removed_trials_in_the_surp)
...
num_of_participants_with_less_than_6_incong_errors <- 0 # counter
num_of_participants_with_less_than_6_incong_error_faces_in_surp <- 0 # counter
# Creating the main empty dataframe that will be filled with the data from the loop below:
main_df <- setNames(data.frame(matrix(ncol = 69, nrow = 0)), c("participant_id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
                                                               ...
                                                               "num_post_incong_correctFaces_reported_new", "num_error_faces_in_surp"))
  ...
  if (participant_included == 1){
    ...
    if (nrow(incong_errorDat) >= incong_error_cutoff){ # checks to see if the participant has at least 6 errors or not.
      ...
      if (num_error_faces_in_surp >= incong_error_cutoff){
        ...
        ##########
        main_df[nrow(main_df) + 1,] <-c(participant_id, congAcc, incongAcc, congCorr_meanRT, incongCorr_meanRT, congCorr_logMeanRT,
        ...
        num_of_participants_with_less_than_6_incong_error_faces_in_surp <- num_of_participants_with_less_than_6_incong_error_faces_in_surp + 1
      }
    } else {
      num_of_participants_with_less_than_6_incong_errors <- num_of_participants_with_less_than_6_incong_errors + 1
    }
  }
}
...
for (zesht4 in 1:nrow(main_df)){
  if (!is.na(as.numeric(main_df$memoryBias_score[zesht4])) && !is.na(as.numeric(main_df$d_prime_error[zesht4])) && !is.na(as.numeric(main_df$d_prime_correct[zesht4])) && !is.na(as.numeric(main_df$d_prime_post_error_minus_pre_error[zesht4])) && !is.na(as.numeric(main_df$d_prime_error_minus_pre_error[zesht4])) && !is.na(as.numeric(main_df$post_d_prime_error[zesht4])) && !is.na(as.numeric(main_df$post_d_prime_correct[zesht4])) && !is.na(as.numeric(main_df$scaared_b_scrdSoc_s1_r1_e1[zesht4])) && !is.na(as.numeric(main_df$scaared_b_scrdTotal_s1_r1_e1[zesht4])) && !is.na(as.numeric(main_df$scaared_b_scrdGA_s1_r1_e1[zesht4])) && !is.na(as.numeric(main_df$d_prime_error_minus_correct[zesht4])) && !is.na(as.numeric(main_df$post_d_prime_error_minus_correct[zesht4])) && !is.na(as.numeric(main_df$bfne_b_scrdTotal_s1_r1_e1[zesht4]))){
    ...
    if (as.numeric(main_df$d_prime_error_minus_pre_error[zesht4]) >= (mean(as.numeric(main_df$d_prime_error_minus_pre_error), na.rm = TRUE) - (3*sd(as.numeric(main_df$d_prime_error_minus_pre_error), na.rm = TRUE))) && as.numeric(main_df$d_prime_error_minus_pre_error[zesht4]) <= (mean(as.numeric(main_df$d_prime_error_minus_pre_error), na.rm = TRUE) + (3*sd(as.numeric(main_df$d_prime_error_minus_pre_error), na.rm = TRUE)))){
      main_df$d_prime_error_minus_pre_error[zesht4] <- as.numeric(main_df$d_prime_error_minus_pre_error[zesht4])
    } else {
      main_df$d_prime_error_minus_pre_error[zesht4] <- NA
    }

    if (as.numeric(main_df$d_prime_post_error_minus_pre_error[zesht4]) >= (mean(as.numeric(main_df$d_prime_post_error_minus_pre_error), na.rm = TRUE) - (3*sd(as.numeric(main_df$d_prime_post_error_minus_pre_error), na.rm = TRUE))) && as.numeric(main_df$d_prime_post_error_minus_pre_error[zesht4]) <= (mean(as.numeric(main_df$d_prime_post_error_minus_pre_error), na.rm = TRUE) + (3*sd(as.numeric(main_df$d_prime_post_error_minus_pre_error), na.rm = TRUE)))){
      main_df$d_prime_post_error_minus_pre_error[zesht4] <- as.numeric(main_df$d_prime_post_error_minus_pre_error[zesht4])
    } else {
      main_df$d_prime_post_error_minus_pre_error[zesht4] <- NA
    }
    ...
    if (as.numeric(main_df$post_d_prime_error_minus_correct[zesht4]) >= (mean(as.numeric(main_df$post_d_prime_error_minus_correct), na.rm = TRUE) - (3*sd(as.numeric(main_df$post_d_prime_error_minus_correct), na.rm = TRUE))) && as.numeric(main_df$post_d_prime_error_minus_correct[zesht4]) <= (mean(as.numeric(main_df$post_d_prime_error_minus_correct), na.rm = TRUE) + (3*sd(as.numeric(main_df$post_d_prime_error_minus_correct), na.rm = TRUE)))){
      main_df$post_d_prime_error_minus_correct[zesht4] <- as.numeric(main_df$post_d_prime_error_minus_correct[zesht4])
    } else {
      main_df$post_d_prime_error_minus_correct[zesht4] <- NA
    }
  }
}
...
for (j in 1:nrow(main_df)){
  if (main_df$num_post_correct_faces[j] < incong_error_cutoff ){
    main_df$post_d_prime_correct[j] <- NA
    main_df$post_d_prime_correct[j] <- NA
  }
  if (main_df$num_pre_correct_faces[j] < incong_error_cutoff ){
    main_df$pre_d_prime_correct[j] <- NA
    main_df$pre_d_prime_correct[j] <- NA
  }
  if (main_df$num_pre_error_faces[j] < incong_error_cutoff ){
    main_df$pre_d_prime_error[j] <- NA
    main_df$pre_d_prime_error[j] <- NA
  }
  if (main_df$num_post_error_faces[j] < incong_error_cutoff ){
...
longDat_sdt_error <- gather(main_df, column_name, value, d_prime_error, pre_d_prime_error, post_d_prime_error)

longDat_sdt_correct <- gather(main_df, column_name, value, d_prime_correct, pre_d_prime_correct, post_d_prime_correct)

longDat_post <- gather(main_df, column_name, value, pre_d_prime_error, d_prime_error, post_d_prime_error, pre_d_prime_correct, d_prime_correct, post_d_prime_correct)
...
t.test(main_df$pre_d_prime_error, main_df$pre_d_prime_correct, paired = TRUE, na.action = na.omit)
t.test(main_df$pre_d_prime_error, main_df$post_d_prime_error, paired = TRUE, na.action = na.omit)
t.test(main_df$pre_d_prime_correct, main_df$post_d_prime_correct, paired = TRUE, na.action = na.omit)
...
cor.test(as.numeric(main_df$scaared_b_scrdSoc_s1_r1_e1), as.numeric(main_df$post_d_prime_error_minus_correct), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$scaared_b_scrdTotal_s1_r1_e1), as.numeric(main_df$post_d_prime_error_minus_correct), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$bfne_b_scrdTotal_s1_r1_e1), as.numeric(main_df$post_d_prime_error_minus_correct), method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=post_d_prime_error_minus_correct, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_d_prime_error_minus_correct, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_d_prime_error_minus_correct, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot

cor.test(as.numeric(main_df$scaared_b_scrdSoc_s1_r1_e1), as.numeric(main_df$d_prime_post_error_minus_pre_error), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$scaared_b_scrdTotal_s1_r1_e1), as.numeric(main_df$d_prime_post_error_minus_pre_error), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$bfne_b_scrdTotal_s1_r1_e1), as.numeric(main_df$d_prime_post_error_minus_pre_error), method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=d_prime_post_error_minus_pre_error, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=d_prime_post_error_minus_pre_error, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=d_prime_post_error_minus_pre_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot

cor.test(as.numeric(main_df$scaared_b_scrdSoc_s1_r1_e1), as.numeric(main_df$d_prime_error_minus_pre_error), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$scaared_b_scrdTotal_s1_r1_e1), as.numeric(main_df$d_prime_error_minus_pre_error), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$bfne_b_scrdTotal_s1_r1_e1), as.numeric(main_df$d_prime_error_minus_pre_error), method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=d_prime_error_minus_pre_error, y=scaared_b_scrdSoc_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=d_prime_error_minus_pre_error, y=scaared_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot
ggplot(main_df, aes(x=d_prime_error_minus_pre_error, y=bfne_b_scrdTotal_s1_r1_e1)) + geom_point() #scatterplot


lm_for_cor_fit_line <- lm(scaared_b_scrdSoc_s1_r1_e1 ~ d_prime_error_minus_correct, main_df)
...
cor.test(as.numeric(main_df$d_prime_error), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$post_d_prime_error), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_error_minus_correct), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$post_d_prime_error_minus_correct), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_error_minus_pre_error), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_post_error_minus_pre_error), as.numeric(main_df$post_error_slowing_score), method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=post_error_slowing_score, y=d_prime_error)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_slowing_score, y=post_d_prime_error)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_slowing_score, y=d_prime_error_minus_correct)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_slowing_score, y=post_d_prime_error_minus_correct)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_slowing_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(main_df, aes(x=post_error_slowing_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot

cor.test(as.numeric(main_df$d_prime_error), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$post_d_prime_error), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_error_minus_correct), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$post_d_prime_error_minus_correct), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_error_minus_pre_error), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_post_error_minus_pre_error), as.numeric(main_df$post_error_accuracy_score), method = 'pearson', na.action = na.omit)
ggplot(main_df, aes(x=post_error_accuracy_score, y=d_prime_error)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_accuracy_score, y=post_d_prime_error)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_accuracy_score, y=d_prime_error_minus_correct)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_accuracy_score, y=post_d_prime_error_minus_correct)) + geom_point() #scatterplot
ggplot(main_df, aes(x=post_error_accuracy_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(main_df, aes(x=post_error_accuracy_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot

lm_for_cor_fit_line <- lm(d_prime_error_minus_correct ~ memoryBias_score, main_df)
...
cor.test(as.numeric(main_df$post_d_prime_error_minus_correct), as.numeric(main_df$memoryBias_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_error_minus_pre_error), as.numeric(main_df$memoryBias_score), method = 'pearson', na.action = na.omit)
cor.test(as.numeric(main_df$d_prime_post_error_minus_pre_error), as.numeric(main_df$memoryBias_score), method = 'pearson', na.action = na.omit)
...
ggplot(main_df, aes(x=memoryBias_score, y=post_d_prime_error_minus_correct)) + geom_point(size = 4) #scatterplot
ggplot(main_df, aes(x=memoryBias_score, y=d_prime_error_minus_pre_error)) + geom_point(size = 4) #scatterplot
ggplot(main_df, aes(x=memoryBias_score, y=d_prime_post_error_minus_pre_error)) + geom_point(size = 4) #scatterplot


for (ss in 1:nrow(main_df)){
  main_df$hitrate[ss] <- main_df$hit_num[ss]/(main_df$hit_num[ss] + main_df$miss_num[ss])
}