...
main_df <- setNames(data.frame(matrix(ncol = 70, nrow = 0)), c("participant_id", "congAcc", "incongAcc", "congCorr_meanRT", "incongCorr_meanRT", "congCorr_logMeanRT", "incongCorr_logMeanRT",
